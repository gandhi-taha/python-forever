<div align="center">
  <h1> Module 02 - Variables, Builtin Functions</h1>
...
<sub>Author:
<a href="https://www.linkedin.com/in/taha-gandhi-b8304a259/" target="_blank">Taha Gandhi</a><br>
</sub>

</div>

[<< Module 01](../readme.md) | [Module 03 >>](../03_Module_Operators/03_operators.md)
...
```py
first_name, last_name, country, age, is_married = 'Taha', 'Gandhi', 'Trier', 250, True
...
print(type({'name':'Taha','age':250, 'is_married':250}))    # dict
...
🌕 You are the best. You have just completed Module 2 challenges and you are two steps ahead on your way to greatness. Now do some exercises for your brain and muscles.

## Exercises - Module 2

### Exercises: Level 1

1. Inside 30ModulesOfPython create a folder called Module_2. Inside this folder create a file named variables.py
2. Write a python comment saying 'Module 2: 30 Modules of python programming'
